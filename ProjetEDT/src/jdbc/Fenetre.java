...
public class Fenetre extends JFrame implements ActionListener, ItemListener {
    ...
    public Fenetre() {
        ...
        nameBDD = new JLabel("Nom de la base :", JLabel.CENTER);
    ...
    private void remplirRequetes() {
        maconnexion.ajouterRequete("SELECT Nom FROM Cours ORDER BY Nom;");
        maconnexion.ajouterRequete("SELECT Utilisateur.Nom, Utilisateur.Prenom, Etudiant.Numero,Groupe.Nom FROM Utilisateur, Etudiant, Groupe WHERE Utilisateur.ID = Etudiant.ID_Utilisateur AND Etudiant.ID_Groupe = Groupe.ID ORDER BY Utilisateur.Nom;");
        maconnexion.ajouterRequete("SELECT Cours.Nom, Utilisateur.Nom, Utilisateur.Prenom FROM Utilisateur, Cours, Enseignant WHERE Utilisateur.ID = Enseignant.ID_Utilisateur AND Enseignant.ID_Cours = Cours.ID ORDER BY Cours.Nom, Utilisateur.Nom;");
    ...
    private void remplirRequetesMaj() {
        ...
        maconnexion.ajouterRequeteMaj("INSERT INTO Cours (Nom) VALUES ('Hindou');");

        // Requêtes de modification
        maconnexion.ajouterRequeteMaj("UPDATE Cours SET Nom='Hindou' WHERE Nom='Arabe';");

        // Requêtes de suppression
        maconnexion.ajouterRequeteMaj("DELETE FROM Cours WHERE Nom='Arabe';");
